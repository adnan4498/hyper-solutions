...
//                   <h4 className="text-gray-800 font-semibold text-base mb-1">{getImageName(imgSrc)}</h4>
...
//           <svg className="w-5 h-5 text-gray-700 group-hover:text-blue-600 transition-colors duration-300 transform group-hover:-translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className={`max-w-7xl mx-auto bg-gradient-to-br ${colors.sectionBg} py-12 lg:py-20 rounded-3xl backdrop-blur-sm border border-white/20 shadow-xl`}>
        ...
        <div className="text-center mb-12 lg:mb-16 px-4">
          <div className="relative inline-block mb-6">
            <h2 className={`text-4xl lg:text-6xl font-black bg-gradient-to-r ${colors.titleGradient} bg-clip-text text-transparent tracking-tight`}>
              {title}
            </h2>
